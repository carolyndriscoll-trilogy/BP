...
export function BrainDumpIcon({ animate }: { animate: boolean }) {
  return (
    ...
    >
      <path d={BRAIN_PATH} opacity={0.4} />
      <path
        d={ARROW_PATH}
        className={animate ? 'animate-brain-dump-arrow' : undefined}
